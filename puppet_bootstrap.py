...
def get_dist_url(dist):
  ...
  return{
         ...
         'Ubuntu14.04_64bit': 'http://apt.puppetlabs.com/puppetlabs-release-trusty.deb',
...
def edit_puppet_conf():
  ...
  if module_path:
    puppet_config.set("main", "modulepath", module_path)
...
def main():
  ...
  if manifest_to_apply:
    call(["/usr/bin/puppet", "apply", "-v", manifest_to_apply])
